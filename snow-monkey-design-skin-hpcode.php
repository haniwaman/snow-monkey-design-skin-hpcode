 ...
 * Description: Snow Monkey のデザインスキンです。HPcode（https://haniwaman.com）風の見栄えになります。
 * Version: 0.1.0
 * Tested up to: 5.6
 * Requires at least: 5.6
 * Requires PHP: 7.3.5
 * Text Domain: snow-monkey-design-skin-hpcode
 * 
 * @license GPL-2.0+
 */
...
add_action(
	...
	function() {
		load_plugin_textdomain(
			'snow-monkey-design-skin-hpcode',
			false,
		...
		add_action(
			...
			function() {
				new Updater(
					...
					'haniwaman', // GitHub user name
					'snow-monkey-design-skin-hpcode', // GitHub repository name
					[
						'homepage' => 'https://haniwaman.com',
					]
				);
			}
		);
